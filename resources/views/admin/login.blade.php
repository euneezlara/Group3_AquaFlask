...
<html lang="en">
	...
	<body class="hold-transition login-page" style="background-color: #6D7B8D">
		...
		<!-- Bootstrap 4 -->
		<script src="{{asset('admin-assets/plugins/plugins/bootstrap/js/bootstrap.bundle.min.js')}}"></script>
		<!-- AdminLTE App -->
		<script src="{{asset('admin-assets/plugins/js/adminlte.min.js')}}"></script>
		<!-- AdminLTE for demo purposes -->
		<script src="{{asset('admin-assets/plugins/js/demo.js')}}"></script>
	</body>
</html>