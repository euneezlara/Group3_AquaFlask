                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    <label for="category">Sub Sategory</label>
                                        ...
                                        @if ($brands->isNotEmpty())
                                            @foreach ($brands as $brand)
                                                <option {{ $product->brand_id == $brand->id ? 'selected' : '' }}
                                                    value="{{ $brand->id }}">{{ $brand->size }}</option>
                                            @endforeach
                                        @endif
                                    </select>
                                </div>
        ...
        const dropzone = new Dropzone("#image", {
            ...
            success: function(file, response) {
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <a href="javascript:void(0)" onclick="deleteImage(${response.image_id})" class="btn btn-danger delete-image">Delete</a>
                    </div>
                </div>
            </div>`;
