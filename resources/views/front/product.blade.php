                                ...
                                @foreach ($product->product_images as $key => $productImage)
                                    <div class="carousel-item {{ $key == 0 ? 'active' : '' }}">
                                        <img class="w-100 h-100"
                                            src="{{ asset('uploads/product/large/' . $product->product_images[$key]->image) }}"
                                            alt="Image">
                                    </div>
                                @endforeach
                            @endif
                ...
                <div class="col-md-7">
                    <div class="bg-light right">
                        ...
                        <div class="d-flex mb-3">
                            ...
                            <small
                                class="pt-2 ps-1">({{ $product->product_ratings_count > 1 ? $product->product_ratings_count . ' Reviews' : $product->product_ratings_count . ' Reviews' }})</small>
                        </div>
                                ...
                                <div class="col-md-12 mt-5">
                                    <div class="overall-rating mb-3">
                                        <div class="d-flex">
                                            ...
                                            <div class="pt-2 ps-2">
                                                ({{ $product->product_ratings_count > 1 ? $product->product_ratings_count . ' Reviews' : $product->product_ratings_count . ' Reviews' }})
                                            </div>
                                        </div>
            ...
            if(response.status == false){
                ...
                var errors = response.errors;
                        ...
                        if (errors.comment) {
                            ...
                            $("#comment").removeClass('is-invalid').siblings('p').html(errors.comment).removeClass('invalid-feedback');
                        }
