                                        ...
                                        <div class="d-block d-sm-flex align-items-start text-center text-sm-start">
                                            ...
                                            <div class="pt-2">
                                                <h3 class="product-title fs-base mb-2"><a
                                                        href="{{ route('front.product', $wishlist->product->slug) }}">{{ $wishlist->product->name }}</a>
                                                </h3>
                                                <span
                                                    class="h5"><strong>₱{{ $wishlist->product->price }}.00</strong></span>
                                                @if ($wishlist->product->compare_price > 0)
                                                    <span
                                                        class="h6 text-underline"><del>₱{{ $wishlist->product->compare_price }}.00</del></span>
                                                @endif
                                            </div>
                                        </div>
